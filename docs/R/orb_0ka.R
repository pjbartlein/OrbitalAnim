...
# get day names
day_names_path <- "Projects/Calendar/animations/data/input/"
day_names_file <- "day_names.txt"
day_names <- read.csv(paste(path_prefix, day_names_path, day_names_file, sep=""), as.is=1)
names(day_names)

# output .pngs path
png_path <- paste(path_prefix, "Projects/Calendar/animations/data/orb_0ka/", sep="")
...
# magick -delay 10 @orb_0ka_files.txt -resize 1080x1080-loop 0 -layers Optimize orb_0ka.gif 
